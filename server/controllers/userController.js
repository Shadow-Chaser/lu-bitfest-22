...
const signUp = async (req, res) => {
    ...
    console.log("🔥 file: userController.js -> line #21 ->  req.body", req.body);
    ...
    try {
        ...
        // await sendEmail(user.email, "Verify Email", verifyLink, result.fullName, "verifyEmail.ejs");
...
const forgetPassword = async (req, res) => {
    try {
        ...
        await sendEmail(user.email, "Reset Password", link, user.fullName, "forgetPassword.ejs");
